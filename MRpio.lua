...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "MR pio"; Text ="欢迎使用w超级脚本; Duration = 4; })
...
about:AddParagraph("w超级作者: wbwhnb")
about:AddParagraph("MR pio作者qq: 425695367")
about:AddParagraph("w超级脚本")
...
about:AddParagraph("严禁倒卖圈钱")
about:AddParagraph("倒卖没亩没坝")
about:AddParagraph("发现倒卖请联系作者")
